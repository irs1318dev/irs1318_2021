...
public class ElectronicsConstants
{
    ...
    public static final int[] ANGLE_CANS = {DRIVETRAIN_ANGLE_MOTOR_1_CAN_ID, DRIVETRAIN_ANGLE_MOTOR_2_CAN_ID, DRIVETRAIN_ANGLE_MOTOR_3_CAN_ID, DRIVETRAIN_ANGLE_MOTOR_4_CAN_ID};
    public static final int[] DRIVE_CANS = {DRIVETRAIN_DRIVE_MOTOR_1_CAN_ID, DRIVETRAIN_DRIVE_MOTOR_2_CAN_ID, DRIVETRAIN_DRIVE_MOTOR_3_CAN_ID, DRIVETRAIN_DRIVE_MOTOR_4_CAN_ID};
    ...
    public static final int[] DRIVETRAIN_ABSOLUTE_ENCODER_ANALOG_INPUTS = {DRIVETRAIN_ABSOLUTE_ENCODER_1_ANALOG_INPUT, DRIVETRAIN_ABSOLUTE_ENCODER_2_ANALOG_INPUT, DRIVETRAIN_ABSOLUTE_ENCODER_3_ANALOG_INPUT, DRIVETRAIN_ABSOLUTE_ENCODER_4_ANALOG_INPUT};
