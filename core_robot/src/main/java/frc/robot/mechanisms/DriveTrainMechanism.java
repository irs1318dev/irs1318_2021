...
public class DriveTrainMechanism implements IMechanism {
    ...
    private final LoggingKey[] encoderAnglesLK = { LoggingKey.DriveTrainAbsoluteEncoderPosition1,
            LoggingKey.DriveTrainAbsoluteEncoderPosition2, LoggingKey.DriveTrainAbsoluteEncoderPosition3,
            LoggingKey.DriveTrainAbsoluteEncoderPosition4 };
    private final LoggingKey[] driveVelocitiesLK = { LoggingKey.DriveTrainDriveVelocity1,
            LoggingKey.DriveTrainDriveVelocity2, LoggingKey.DriveTrainDriveVelocity3,
            LoggingKey.DriveTrainDriveVelocity4 };
    private final LoggingKey[] drivePositionsLK = { LoggingKey.DriveTrainDrivePosition1,
            LoggingKey.DriveTrainDrivePosition2, LoggingKey.DriveTrainDrivePosition3,
            LoggingKey.DriveTrainDrivePosition4 };
    private final LoggingKey[] driveErrorsLK = { LoggingKey.DriveTrainDriveError1, LoggingKey.DriveTrainDriveError2,
            LoggingKey.DriveTrainDriveError3, LoggingKey.DriveTrainDriveError4 };
    private final LoggingKey[] angleVelocitiesLK = { LoggingKey.DriveTrainAngleVelocity1,
            LoggingKey.DriveTrainAngleVelocity2, LoggingKey.DriveTrainAngleVelocity3,
            LoggingKey.DriveTrainAngleVelocity4 };
    private final LoggingKey[] anglePositionsLK = { LoggingKey.DriveTrainAnglePosition1,
            LoggingKey.DriveTrainAnglePosition2, LoggingKey.DriveTrainAnglePosition3,
            LoggingKey.DriveTrainAnglePosition4 };
    private final LoggingKey[] angleErrorsLK = { LoggingKey.DriveTrainAngleError1, LoggingKey.DriveTrainAngleError2,
            LoggingKey.DriveTrainAngleError3, LoggingKey.DriveTrainAngleError4 };
    private final LoggingKey[] driveGoalLK = { LoggingKey.DriveTrainDriveVelocityGoal1,
            LoggingKey.DriveTrainDriveVelocityGoal2, LoggingKey.DriveTrainDriveVelocityGoal3,
            LoggingKey.DriveTrainDriveVelocityGoal4 };
    private final LoggingKey[] angleGoalLK = { LoggingKey.DriveTrainAnglePositionGoal1,
            LoggingKey.DriveTrainAnglePositionGoal2, LoggingKey.DriveTrainAnglePositionGoal3,
            LoggingKey.DriveTrainAnglePositionGoal4 };

    @Inject
    public DriveTrainMechanism(LoggingManager logger, IRobotProvider provider, PositionManager positionManager) {
        this.logger = logger;
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            this.driveMotors[i].setPIDF(TuningConstants.DRIVETRAIN_DRIVE_MOTOR_VELOCITY_PID_KP[i],
                    TuningConstants.DRIVETRAIN_DRIVE_MOTOR_VELOCITY_PID_KI[i],
                    TuningConstants.DRIVETRAIN_DRIVE_MOTOR_VELOCITY_PID_KD[i],
                    TuningConstants.DRIVETRAIN_DRIVE_MOTOR_VELOCITY_PID_KF[i], DriveTrainMechanism.pidSlotId);
            this.driveMotors[i].setVoltageCompensation(TuningConstants.DRIVETRAIN_VOLTAGE_COMPENSATION_ENABLED,
                    TuningConstants.DRIVETRAIN_VOLTAGE_COMPENSATION);
            this.driveMotors[i].setSupplyCurrentLimit(TuningConstants.DRIVETRAIN_SUPPLY_CURRENT_LIMITING_ENABLED,
                    TuningConstants.DRIVETRAIN_SUPPLY_CURRENT_MAX, TuningConstants.DRIVETRAIN_SUPPLY_TRIGGER_CURRENT,
            ...
            this.angleMotors[i].setPIDF(TuningConstants.DRIVETRAIN_ANGLE_MOTOR_POSITION_PID_KP[i],
                    TuningConstants.DRIVETRAIN_ANGLE_MOTOR_POSITION_PID_KI[i],
                    TuningConstants.DRIVETRAIN_ANGLE_MOTOR_POSITION_PID_KD[i],
                    TuningConstants.DRIVETRAIN_ANGLE_MOTOR_POSITION_PID_KF[i], DriveTrainMechanism.pidSlotId);

            this.angleMotors[i].setControlMode(TalonSRXControlMode.Position);

            this.absoluteEncoders[i] = provider
                    .getAnalogInput(ElectronicsConstants.DRIVETRAIN_ABSOLUTE_ENCODER_ANALOG_INPUT[i]);
        }
    ...
    public static double getClosestAngle(double desiredAngle, double currentAngle) {
        ...
        double[] closeRotations = { (desiredAngle + 360.0 * (multiplicand - 1.0)),
                (desiredAngle + 360.0 * multiplicand), (desiredAngle + 360.0 * (multiplicand + 1.0)), };
    ...
    private Setpoint[] calculateSetpoints() {
        double a = this.driver.getAnalog(AnalogOperation.DriveTrainRotationA); // center of rotation set to center of
                                                                               // robot for now
